...
public class AlumnosDialog extends JDialog{
    ...
    public AlumnosDialog(JFrame parent) {
        ...
        carreras = new String[]{"SISTEMAS","ELECTRONICA","INDUSTRIAL","AMBIENTAL","CIVIL","ARQUITECTURA","NUTRICION", "GASTRONOMIA", "FISIOTERAPIA","LENGUAS","CONTABILIDAD", "DERECHO", "ENFERMERIA"};
        comboBoxCarreras = new JComboBox(carreras);
        comboBoxCarreras.setSelectedIndex(-1);
        lblCarrera = new JLabel("Selecciona Carrera");
        ...
        btnAceptar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    JOptionPane.showMessageDialog(AlumnosDialog.this, "Ingrese todos los datos", "Error", JOptionPane.ERROR_MESSAGE);
                    JOptionPane.showMessageDialog(AlumnosDialog.this, "Error en la Calificación", "Error", JOptionPane.ERROR_MESSAGE);
                } catch (NumberFormatException ex) {
                    JOptionPane.showMessageDialog(AlumnosDialog.this, "Error en la calificaion", "Error", JOptionPane.ERROR_MESSAGE);
                    JOptionPane.showMessageDialog(AlumnosDialog.this, "Error en la calificaion", "Error", JOptionPane.ERROR_MESSAGE);
                }
            }
        });
